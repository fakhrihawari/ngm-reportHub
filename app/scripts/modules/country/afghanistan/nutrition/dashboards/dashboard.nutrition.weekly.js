						...
						rows: [{
							...
							columns: [{
								...
								widgets: [{
									...
									config: {
										title: 'beneficiaries',//$filter('translate')('beneficiaries'),
							...
							columns: [{
								...
								widgets: [{
									...
									card: 'card-panel stats-card white grey-text text-darken-2',
									config: {
										title: 'reports',//$filter('translate')('reports'),
								...
								widgets: [{
									...
									card: 'card-panel stats-card white grey-text text-darken-2',
									config: {
										title: 'activities',//$filter('translate')('activities'),
								...
								widgets: [{
									...
									card: 'card-panel stats-card white grey-text text-darken-2',
									config: {
										title: 'locations',//$filter('translate')('locations'),
