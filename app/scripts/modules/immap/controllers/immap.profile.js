/**
 * @ngdoc function
 * @name ngmReportHubApp.ImmapProfileCtrl
 * @description
 * # ImmapTeamCtrl
 * Controller of the ngmReportHub
 */
angular.module('ngmReportHub')
	.controller('ImmapProfileCtrl', ['$scope', '$location', '$route', 'ngmAuth', 'ngmData', 'ngmUser', '$translate', '$filter', function ($scope, $location, $route, ngmAuth, ngmData, ngmUser, $translate, $filter) {
		this.awesomeThings = [
			'HTML5 Boilerplate',
			'AngularJS',
			'Karma'
				...
				$scope.model = {
					...
					header: {
						...
						title: {
							...
							title: 'iMMAP | ' + $scope.dashboard.user.admin0name + ' | My Profile'
						},
						subtitle: {
					...
					rows: [{
						columns: [{
							...
							widgets: [{
								...
								config: {
									...
									profileHref: '#',
									templateUrl: '/scripts/modules/immap/views/immap.profile.html'
								}
							}]
						},{
							styleClass: 's12 m6',
						...
						columns: [{
							...
							widgets: [{
								...
								style: 'padding:0px;',
								config: {
									html: '<h2 class="col s12 report-title" style="margin-top: 20px; padding-bottom: 10px; font-size: 3.0rem; font-weight:300; color: #959595; border-bottom: 3px #A72824 solid;">My Monthly Performance</h2>'
								}
							}]
						}]
					}, {
						...
						columns: [{
							...
							widgets: [{
								...
								style: 'padding:0px;',
								config: {
									html: '<h2 class="col s12 report-title" style="margin-top: 20px; padding-bottom: 10px; font-size: 3.0rem; font-weight:300; color: #959595; border-bottom: 3px #A72824 solid;">My Overall Performance</h2>'
								}
							}]
						}]
					}, {
