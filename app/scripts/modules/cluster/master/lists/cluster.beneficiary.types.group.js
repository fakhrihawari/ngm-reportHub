...
angular.module('ngmReportHub')
    .controller('MasterListBeneficairyTypesGroupCtrl', ['$scope', '$location', '$route', 'ngmAuth', 'ngmData', 'ngmUser', 'ngmClusterLists',
        // 'ngmMasterListHelper', 
                        ...
                        rows: [{
                            ...
                            columns: [{
                                ...
                                widgets: [{
                                    ...
                                    style: 'padding: 0px;',
                                    config: {
                                        templateUrl: '/scripts/modules/cluster/master/views/cluster.beneficiary.types.html',
