...
angular
	...
	.config([ '$routeProvider', '$compileProvider', function ( $routeProvider, $compileProvider) {
		...
		$routeProvider
			...
			.when('/cluster/admin/list/site_type/:admin0pcode?', {
				templateUrl: '/views/app/dashboard.html',
				controller: 'ListSiteTypeCtrl',
				resolve: {
					access: ['ngmAuth', function (ngmAuth) {
						return ngmAuth.isAuthenticated();
					}]
			...
			.when('/cluster/admin/list/admin1/:admin0pcode?', {
				templateUrl: '/views/app/dashboard.html',
				controller: 'ListAdmin1Ctrl',
				resolve: {
					access: ['ngmAuth', function (ngmAuth) {
						return ngmAuth.isAuthenticated();
					}]
			...
			.when('/cluster/admin/list/admin2/:admin0pcode?', {
				templateUrl: '/views/app/dashboard.html',
				controller: 'ListAdmin2Ctrl',
				resolve: {
					access: ['ngmAuth', function (ngmAuth) {
						return ngmAuth.isAuthenticated();
					}]
			...
			.when('/cluster/admin/list/admin3/:admin0pcode?', {
				templateUrl: '/views/app/dashboard.html',
				controller: 'ListAdmin3Ctrl',
				resolve: {
					access: ['ngmAuth', function (ngmAuth) {
						return ngmAuth.isAuthenticated();
					}]
			...
			.when('/cluster/admin/list/admin4/:admin0pcode?', {
				templateUrl: '/views/app/dashboard.html',
				controller: 'ListAdmin4Ctrl',
				resolve: {
					access: ['ngmAuth', function (ngmAuth) {
						return ngmAuth.isAuthenticated();
					}]
			...
			.when('/cluster/admin/list/admin5/:admin0pcode?', {
				templateUrl: '/views/app/dashboard.html',
				controller: 'ListAdmin5Ctrl',
				resolve: {
					access: ['ngmAuth', function (ngmAuth) {
						return ngmAuth.isAuthenticated();
					}]
			...
			.when('/cluster/admin/list/mpc_type/:admin0pcode?', {
				templateUrl: '/views/app/dashboard.html',
				controller: 'ListMpcTypeCtrl',
				resolve: {
					access: ['ngmAuth', function (ngmAuth) {
						return ngmAuth.isAuthenticated();
					}]
			...
			.when('/cluster/admin/list/admin_site/:admin0pcode?', {
				templateUrl: '/views/app/dashboard.html',
				controller: 'ListAdminSiteCtrl',
				resolve: {
					access: ['ngmAuth', function (ngmAuth) {
						return ngmAuth.isAuthenticated();
					}]
