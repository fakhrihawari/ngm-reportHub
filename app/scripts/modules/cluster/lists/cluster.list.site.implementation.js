/**
 * @ngdoc function
 * @name ngmReportHubApp.controller:ListSiteImplementationCtrl
 * @description
 * # ListSiteImplementationCtrl
 * Controller of the ngmReportHub
 */
angular.module('ngmReportHub')
    .controller('ListSiteImplementationCtrl', ['$scope', '$location', '$route', 'ngmAuth', 'ngmData', 'ngmUser', 'ngmClusterHelper', '$translate', '$filter', '$rootScope', 'ngmClusterLists', 'listService', function ($scope, $location, $route, ngmAuth, ngmData, ngmUser, ngmClusterHelper, $translate, $filter, $rootScope, ngmClusterLists, listService) {
        this.awesomeThings = [
            'HTML5 Boilerplate',
            'AngularJS',
            'Karma'
                ...
                $scope.model = {
                    ...
                    header: {
                        ...
                        title: {
                            ...
                            title: 'Site Implementation | ' + $scope.list.title
                        },
                        subtitle: {
                            'class': 'col s12 m12 l12 report-subtitle hide-on-small-only',
                            title: 'List Site Implementation For ' + $scope.list.title
                        },
                        download: {
                            ...
                            downloads: [
                                {
                                    ...
                                    icon: 'assignment',
                                    hover: 'Download Site Implementation List CSV',
                                    // request: {
                                    //     method: 'GET',
                                    ...
                                    color: 'blue lighten-2',
                                    icon: 'description',
                                    hover: 'Download Site Implementation List Excel',
                                    // request: {
                                    //     method: 'GET',
                    ...
                    rows: [{
                        ...
                        columns: [{
                            styleClass: 's12 m12 l12',
                            widgets: [{
                                type: 'form.site.implementation.list',
                                style: 'padding:0px; height: 90px; padding-top:10px;',
                                config: {
                                    style: $scope.list.ngm.style,
                                    site_implementations: $scope.list.site_implementations,
        ...
        }).then(function (site_implementations) {
            if (site_implementations.length) {
                $scope.list.site_implementations = site_implementations;
