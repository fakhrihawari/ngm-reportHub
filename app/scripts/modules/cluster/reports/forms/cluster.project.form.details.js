        ...
        showCash: function() {
          return ngmClusterBeneficiaries.showCash( $scope.project.definition.target_beneficiaries );
				...
				showDeliveryfield: function () {					
					return ngmClusterBeneficiaries.showDeliveryfield($scope.project.definition.target_beneficiaries, 'esnfi', $scope.project.lists.mpc_delivery_types, $scope.project.definition.admin0pcode);
				},
