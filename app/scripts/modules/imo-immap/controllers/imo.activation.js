...
angular.module('ngmReportHub')
	.controller('ImoActivationCtrl', ['$scope', '$translate', '$filter', '$location', function ($scope, $translate, $filter, $location) {
		this.awesomeThings = [
			'HTML5 Boilerplate',
			'AngularJS',
			'Karma'
				...
				columns: [{
					...
					widgets: [{
						...
						config: {
							...
							templateUrl: '/scripts/widgets/ngm-html/template/activation.html'
						}
					}]
				}]
			}]
