...
angular.module('ngmReportHub')
	.controller('ImoLoginCtrl', ['$scope', '$translate', '$filter', '$location', function ($scope, $translate, $filter, $location) {
		this.awesomeThings = [
			'HTML5 Boilerplate',
			'AngularJS',
			'Karma'
		...
		var model = {
			...
			header: {
				...
				subtitle: {
					...
					html: true,
					title: '<span class="hide-on-med-and-down">, ' + $filter('translate')('please_login_or_register_to_continue') + '</span>'
				}
			},
			rows: [{
				columns: [{
					...
					widgets: [{
						...
						config: {
							...
							templateUrl: '/scripts/modules/imo-immap/views/imo.login.html'
						}
					}]
				}]
			}]
