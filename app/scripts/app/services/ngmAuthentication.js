...
angular.module('ngmReportHub')
	...
	.constant( 'ngmPermissions', [{ 
			...
			TEAM_RESTRICTED: [],
			TEAM_MENU: [],
			EDIT_LIST_RESTRICTED: [ 'admin0pcode', 'organization_tag' ],
			VALIDATE: false,
			LEVEL: 0,
		...
		{ 
			...
			EDIT_LIST_RESTRICTED: ['admin0pcode', 'cluster_id'],
			VALIDATE: true,
			LEVEL: 3,
		...
		{ 
			...
			EDIT_LIST_RESTRICTED: ['admin0pcode'],
			VALIDATE: true,
			LEVEL: 4,
		...
		{ 
			...
			EDIT_LIST_RESTRICTED: ['adminRpcode', 'organization_tag'],
			VALIDATE: false,
			LEVEL: 5,
		...
		{ 
			...
			EDIT_LIST_RESTRICTED: ['adminRpcode'],
			VALIDATE: false,
			LEVEL: 6,
		...
		{ 
			...
			EDIT_LIST_RESTRICTED: ['organization_tag'],
			VALIDATE: false,
			LEVEL: 7,
