			...
			setStats: function() {
				...
				var stats_org_level = [{
					...
					widgets: [{
						...
						config: {
							title: 'active_staff',//'Active Staff',
				...
				var stats_cluster_level = [{
					...
					widgets: [{
						...
						card: 'card-panel stats-card white grey-text text-darken-2',
						config: {
							title: 'active_partners',//'Active Partners',
							request: $scope.dashboard.getRequest( 'total', 'active' )
						}
					}]
				}];
				...
				var stats_country_level_above_org = [{
					...
					widgets: [{
						...
						card: 'card-panel stats-card white grey-text text-darken-2',
						config: {
							title: 'countries_mayus',//'Countries',
						...
						columns: [{
							...
							widgets: [{
								...
								config: {
									...
									headerIcon: 'group',
									headerTitle: 'active_users',//$filter('translate')('active_users'),
						...
						columns: [{
							...
							widgets: [{
								...
								config: {
									...
									headerText: 'white-text',
									headerIcon: 'group',
									headerTitle: 'desactivated_users',//$filter('translate')('desactivated_users'),
									templateUrl: '/scripts/app/views/authentication/team.html',
									tableOptions:{
										count: 10,
										sorting: { updatedAt: "desc" } 
